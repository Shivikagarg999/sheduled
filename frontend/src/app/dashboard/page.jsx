          ...
          <div className="relative z-10">
            ...
            {userName && (
              <motion.div
                ...
                className="absolute top-4 right-4 bg-white bg-opacity-80 px-4 py-2 rounded-full shadow-sm"
              >
                <p className="text-gray-700 font-medium">Hi, {userName}</p>
              </motion.div>
            )}
            ...
            >
              ...
              <motion.h1 
                variants={fadeIn}
                className="text-3xl md:text-4xl text-black mt-2 mb-4"
              >
